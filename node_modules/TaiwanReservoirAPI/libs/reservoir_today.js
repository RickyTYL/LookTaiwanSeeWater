    ...
    async.waterfall([
        ...
        function (html, cb){
            ...
            $('.list').find('tr').each(function (i, elem){
                ...
                var immediateTime = td.eq(7).text().trim().replace(/(\r\n|\n|\r|\s)/g,'');
                var immediateLevel = td.eq(8).text().trim().replace(/(\r\n|\n|\r|\s)/g,'');
                var immediateStorage = td.eq(9).text().trim().replace(/(\r\n|\n|\r|\s)/g,'');
                var immediatePercentage = td.eq(10).text().trim().replace(' %','');
